    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel4">Contact</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-0">
                        ...
                        <input type="text" class="form-control" value={{ $contact->email }} @readonly(true)
                            @disabled(true)>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col mb-0">
                        <div>
                            ...
                            <textarea class="form-control" rows="3"@readonly(true) @disabled(true)>{{ $contact->content }} </textarea>
                        </div>
                    </div>
                </div>
