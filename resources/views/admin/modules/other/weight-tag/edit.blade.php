...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.other.weight-tag.update', ['id' => $id]) }}">
                    @csrf
                    ...
                    <div class="row g-2">
                        <div class="col mb-2">
                            ...
                            <input type="text" id="mass" class="form-control" placeholder="Enter gram (1000 = 1kg)"
                                name="mass" value="{{ old('mass', $data->mass) }}" />
                            @if ($errors->has('mass'))
                    ...
                    <div class="row ">
                        <div class="col d-flex  justify-content-end">
                            ...
                            <a href="{{ route('admin.other.weight-tag.index') }}" class="btn btn-secondary">Cancel</a>
                        </div>
